...
- Take the code from the file [10_RL_Control.py](10_RL_Control.py) as starting point.
This code uses a random policy and plots the collected rewards over time.
- Integrate the code for calculating Q-values after every episode [from the last lab](solutions/09_FrozenLake_Prediction_Task1.py).
