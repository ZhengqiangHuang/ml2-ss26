# Exercise 09 - RL Prediction


In this lab, we continue working on the [FrozenLake environment](https://gymnasium.farama.org/environments/toy_text/frozen_lake/)
and implement the concept of Q-value prediction with the Monte Carlo method.


### Task 1:
- Download and execute `09_FrozenLake_Prediction.py` on GitHub.
